...
const THEME_INIT = `(function(){try{var t=localStorage.getItem('folio-theme');var d=t?t==='dark':true;var c=document.documentElement.classList;c.remove('light','dark');c.add(d?'dark':'light');}catch(e){document.documentElement.classList.add('dark');}})();`;
